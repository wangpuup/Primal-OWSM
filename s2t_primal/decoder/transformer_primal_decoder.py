...
from espnet2.s2t_primal.transformer.attention import MultiHeadedAttention
from espnet2.s2t_primal.transformer.decoder_layer import PrimalDecoderLayer
...
class BaseTransformerDecoder(AbsDecoder, BatchScorerInterface, MaskParallelScorerInterface):
    ...
    def __init__(
        ...
        self._output_size_bf_softmax = encoder_output_size
...
class PrimalTransformerDecoder(BaseTransformerDecoder):
    @typechecked
    def __init__(
        self,
        vocab_size: int,
        ...
        self.decoders = repeat(
            num_blocks,
            lambda lnum: PrimalDecoderLayer(
                attention_dim,
                MultiHeadedAttention(
                    attention_heads, encoder_output_size, attention_dim, self_attention_dropout_rate
                ),
                MultiHeadedAttention(
                    attention_heads, encoder_output_size, attention_dim, src_attention_dropout_rate
                ),
