...
class Speech2Text:
    ...
    def __init__(
        ...
        quantize_dtype: torch.dtype = getattr(torch, quantize_dtype)
         ...
         # 1. Build S2T model
        s2t_model, s2t_train_args = S2TPRIMALTask.build_model_from_file(
    ...
    def __call__(
        ...
        # b. Forward Encoder
        enc, _ , _ = self.s2t_model.encode(**batch)
...
def inference(
    ...
    loader = S2TPRIMALTask.build_streaming_iterator(
        data_path_and_name_and_type,
        dtype=dtype,
        batch_size=batch_size,
        key_file=key_file,
        num_workers=num_workers,
        preprocess_fn=S2TPRIMALTask.build_preprocess_fn(speech2text.s2t_train_args, False),
        collate_fn=S2TPRIMALTask.build_collate_fn(speech2text.s2t_train_args, False),
