...
from espnet2.s2t_primal.decoder.transformer_primal_decoder import PrimalTransformerDecoder
...
from espnet2.s2t_primal.encoder.transformer_primal_encoder import PrimalTransformerEncoder
...
from espnet2.s2t_primal.espnet_primal_model import ESPnetS2TPRIMALModel
...
encoder_choices = ClassChoices(
    ...
    classes=dict(
        ...
        primaltransformer=PrimalTransformerEncoder,
...
decoder_choices = ClassChoices(
    "decoder",
    classes=dict(
        primaltransformer=PrimalTransformerDecoder,
...
class S2TPRIMALTask(AbsTask):
    ...
    @classmethod
    @typechecked
    def build_model(cls, args: argparse.Namespace) -> ESPnetS2TPRIMALModel:
        #print(args)
